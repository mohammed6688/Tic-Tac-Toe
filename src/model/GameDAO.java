...
public class GameDAO {
    ...
    public synchronized List <Player> getOnlinePlayers(){
        ...
        try {
            ...
            PreparedStatement stmt=con.prepareStatement("select * from player where status = true",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    public int createGameSession(String MainPlayer,String SecondaryPlayer) throws SQLException {
        try {
            ...
            PreparedStatement stmt=con.prepareStatement("insert into game (gameDate,gameStatus) values(?,?) ", Statement.RETURN_GENERATED_KEYS);
